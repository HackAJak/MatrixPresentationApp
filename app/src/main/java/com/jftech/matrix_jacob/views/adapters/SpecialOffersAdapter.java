...
import com.jftech.matrix_jacob.utilities.ViewExtension;
...
public class SpecialOffersAdapter extends RecyclerView.Adapter<SpecialOffersAdapter.SpecialOfferViewHolder>
{
    ...
    public  SpecialOffersAdapter(SpecialOffer[] specialOffers, MainActivityViewModel viewModel, int smallSeparatorMargin)
    {
        this.specialOffers = specialOffers;
        viewModelReference = viewModel;
        this.OfferCount = specialOffers.length;
        this.smallSeparatorMargin = smallSeparatorMargin;
    }
    ...
    public void onBindViewHolder(@NonNull SpecialOfferViewHolder holder, int position)
    {
        ...
        //set default calculated margin
        ViewExtension.setMargins(holder.itemView, smallSeparatorMargin, 0, 0, 0);
